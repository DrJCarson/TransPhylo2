---
title: "Example where all demes have the same offspring distribution and sampling probabilities"
author: "Xavier Didelot"
date: '`r Sys.Date()`'
output: html_vignette
vignette: >
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteIndexEntry{Example where all demes have the same offspring distribution and sampling probabilities}
