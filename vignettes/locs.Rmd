---
title: "Illustration of geographical functionality"
author: "Xavier Didelot"
date: '`r Sys.Date()`'
output: html_vignette
vignette: >
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteIndexEntry{Illustration of geographical functionality}
...
simu <- simulateOutbreak(kappa=0.25,lambda=0.25,pi=0.25,off.r=5,w.shape=10,
                         w.scale=0.1,dateStartOutbreak=2005,dateT=2008,nLocs=2,rho=0.8)
```
...
```{r,results='hide'}
ptree<-ptreeFromPhylo(p,dateLastSample=dateLastSample(simu))
ptree$locations=simu$locations
