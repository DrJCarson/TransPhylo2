...
Carson et al. (2024). Incorporating epidemiological data into the genomic analysis of partially sampled infectious disease outbreaks. In preparation.
...
For more detailed examples of how to use TransPhylo2, see the vignettes [here](https://github.com/DrJCarson/TransPhyloMulti/tree/master/vignettes).
